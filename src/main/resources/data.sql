...
(5, '660e8400-e29b-41d4-a716-446655440005', 299.99, 399.99, 'TKT-005', 'SOLD', 'PREMIUM', 1);

-- Insert Tickets for Event 2
INSERT INTO tickets (id, public_id, price, original_price, ticket_number, status, category, event_id) VALUES
(6, '660e8400-e29b-41d4-a716-446655440006', 199.99, 199.99, 'TKT-006', 'AVAILABLE', 'PREMIUM', 2),
(7, '660e8400-e29b-41d4-a716-446655440007', 249.99, 299.99, 'TKT-007', 'SOLD', 'VIP', 2),
...
INSERT INTO tickets (id, public_id, price, original_price, ticket_number, status, category, event_id) VALUES
(11, '660e8400-e29b-41d4-a716-446655440011', 79.99, 89.99, 'TKT-011', 'SOLD', 'STANDARD', 3),
...
INSERT INTO tickets (id, public_id, price, original_price, ticket_number, status, category, event_id) VALUES
(16, '660e8400-e29b-41d4-a716-446655440016', 129.99, 129.99, 'TKT-016', 'SOLD', 'STANDARD', 4),
(17, '660e8400-e29b-41d4-a716-446655440017', 169.99, 189.99, 'TKT-017', 'SOLD', 'STANDARD', 4),
...
INSERT INTO tickets (id, public_id, price, original_price, ticket_number, status, category, event_id) VALUES
(21, '660e8400-e29b-41d4-a716-446655440021', 49.99, 59.99, 'TKT-021', 'SOLD', 'STANDARD', 5),
...
(28, '660e8400-e29b-41d4-a716-446655440028', 149.99, 169.99, 'TKT-028', 'SOLD', 'VIP', 6),
...
(32, '660e8400-e29b-41d4-a716-446655440032', 199.99, 249.99, 'TKT-032', 'SOLD', 'VIP', 7),
...
(39, '660e8400-e29b-41d4-a716-446655440039', 119.99, 129.99, 'TKT-039', 'SOLD', 'VIP', 8),
(40, '660e8400-e29b-41d4-a716-446655440040', 139.99, 179.99, 'TKT-040', 'AVAILABLE', 'PREMIUM', 8);

-- Insert Tickets for Event 9
INSERT INTO tickets (id, public_id, price, original_price, ticket_number, status, category, event_id) VALUES
(41, '660e8400-e29b-41d4-a716-446655440041', 39.99, 49.99, 'TKT-041', 'SOLD', 'STANDARD', 9),
